...
export default function Pediatrics() {
    ...
    const  getDoctoretCardio = async () => {
        ...
        const pediatricians = doctorsReadableData.filter(doctor => doctor.speciality === "pediatrician");
        setDoctor(pediatricians);
  ...
  return (
        <div>
            <main id="home" className='hero-block'>
                <h1 className='connection'>Our Pediatricians</h1>
